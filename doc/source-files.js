...
sourcesIndex["gfx_backend_vulkan"] = {"name":"","files":["command.rs","conv.rs","device.rs","info.rs","lib.rs","native.rs","physical_device.rs","pool.rs","window.rs"]};
...
sourcesIndex["naga"] = {"name":"","dirs":[{"name":"back","dirs":[{"name":"glsl","files":["features.rs","keywords.rs","mod.rs"]},{"name":"msl","files":["keywords.rs","mod.rs","sampler.rs","writer.rs"]},{"name":"spv","files":["helpers.rs","instructions.rs","layout.rs","mod.rs","writer.rs"]}],"files":["mod.rs"]},{"name":"front","dirs":[{"name":"spv","files":["convert.rs","error.rs","flow.rs","function.rs","image.rs","mod.rs","null.rs"]},{"name":"wgsl","files":["conv.rs","layout.rs","lexer.rs","mod.rs"]}],"files":["mod.rs"]},{"name":"proc","files":["interpolator.rs","mod.rs","namer.rs","terminator.rs","typifier.rs"]},{"name":"valid","files":["analyzer.rs","compose.rs","expression.rs","function.rs","interface.rs","mod.rs","type.rs"]}],"files":["arena.rs","lib.rs"]};
...
sourcesIndex["rose_tree"] = {"name":"","files":["lib.rs"]};
